...
<?php else: ?>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-nav">
            <a href="admin.php?tab=stats" class="sidebar-item <?= $tab==='stats'?'active':'' ?>">
                <span class="ic">📊</span><span class="label">Thống kê</span>
                <?php if ($tab==='stats'): ?><span class="chev">›</span><?php endif; ?>
            </a>
            <a href="admin.php?tab=keys" class="sidebar-item <?= $tab==='keys'?'active':'' ?>">
                <span class="ic">🔑</span><span class="label">Quản lý Key</span>
                <?php if ($tab==='keys'): ?><span class="chev">›</span><?php endif; ?>
            </a>
            <a href="admin.php?tab=game" class="sidebar-item <?= $tab==='game'?'active':'' ?>">
                <span class="ic">🎮</span><span class="label">Cấu hình Game</span>
                <?php if ($tab==='game'): ?><span class="chev">›</span><?php endif; ?>
            </a>
            <a href="admin.php?tab=link" class="sidebar-item <?= $tab==='link'?'active':'' ?>">
                <span class="ic">🔗</span><span class="label">Cấu hình rút gọn</span>
                <?php if ($tab==='link'): ?><span class="chev">›</span><?php endif; ?>
            </a>
        </div>
        <div class="sidebar-footer">
            <a href="<?= htmlspecialchars(BASE_URL) ?>/" class="sidebar-back">← Về trang người dùng</a>
    ...
    <div class="box">
        <h3>🚫 Thiết bị bị cấm vĩnh viễn</h3>
