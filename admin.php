        ...
        <div class="region-form" style="margin-top:17px;border-color:rgba(89,245,213,.22)">
            ...
            <form method="post" enctype="multipart/form-data" style="display:flex;flex-direction:column;gap:10px">
                ...
                <div style="display:flex;flex-wrap:wrap;gap:10px;margin-top:2px">
                    <div style="flex:1;min-width:260px">
                        <label style="display:block;font-size:11.5px;color:var(--text-dim);margin-bottom:4px">📡 <b>Kênh Thông Báo Phát Key (Channel)</b> (tùy chọn):</label>
                        <input type="text" name="tg_broadcast_channel" value="<?= htmlspecialchars($tgBotCfg['broadcast_channel'] ?? '') ?>" placeholder="vd: @hoquoc30 (để trống bot tự phát hiện kênh từ danh sách)" style="width:100%">
                        <span style="font-size:10.5px;color:var(--text-dim)">Chỉ đăng tin phát Key 20H/40H (che mã key &amp; tag user). Không gửi tin tham gia nhóm vào đây.</span>
                    </div>
                    <div style="flex:1;min-width:200px">
                        <label style="display:block;font-size:11.5px;color:var(--text-dim);margin-bottom:4px">👥 <b>Nhóm Chat Thảo Luận (Group)</b> (tùy chọn):</label>
                        <input type="text" name="tg_discussion_group" value="<?= htmlspecialchars($tgBotCfg['discussion_group'] ?? '') ?>" placeholder="vd: @AuraPingVN (để trống bot tự phát hiện nhóm từ danh sách)" style="width:100%">
                        <span style="font-size:10.5px;color:var(--text-dim)">Nhận tin chào mừng user đã tham gia đủ nhóm. Không nhận tin phát mã key.</span>
                    </div>
                </div>
