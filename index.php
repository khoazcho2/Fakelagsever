...
.eyebrow span{color:var(--cyan)}
h1{font-size:clamp(34px,6vw,56px);line-height:1.02;letter-spacing:-.055em;margin:0 auto 13px;max-width:620px}
...
a.btn{min-height:47px;border-radius:13px;color:#071018;background:linear-gradient(110deg,var(--cyan),#B5FFF0 45%,var(--violet));box-shadow:0 10px 24px -12px rgba(89,245,213,.65);font-size:14px}
