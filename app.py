...
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .stat-num { font-size: 22px; font-weight: bold; color: #eee; }
...
function renderKeys(keys) {
  ...
  if (entries.length === 0) {
    el.innerHTML = "<p style='color:#666;text-align:center;padding:20px'>Không tìm thấy key nào</p>";
  } else {
  ...
  document.getElementById("statActive").textContent = total - expiredCount;
