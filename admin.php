        ...
        <div class="game-card">
            ...
            <div class="getkey-link-card">
                ...
                <div class="getkey-link-row">
                    ...
                    <button type="button" onclick="const el=document.getElementById('getkeylink-<?= $g['id'] ?>');navigator.clipboard.writeText(el.value);const b=this;const orig=b.innerHTML;b.innerHTML='<?= addslashes(svg_icon('check-circle', 16)) ?> Đã chép';setTimeout(()=>b.innerHTML=orig,1500)">
                        <?= svg_icon('copy', 16) ?> Sao chép
                    </button>
                </div>
            </div>
        </div>
