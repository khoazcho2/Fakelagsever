...
if (isset($_POST['channel_gate'])) {
    ...
    if (!empty($notReady)) {
        render_channel_gate($game, $channels, $pendingToken, $expectedGate, $publicNotice, 'Vui lòng bấm Tham Gia và đợi đủ ' . CHANNEL_WAIT_SECONDS . ' giây cho từng kênh.', $openedChannels);
        exit;
    }
