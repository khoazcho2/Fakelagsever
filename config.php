...
function render_shorten_error(): void {
    ...
    <style>body{font-family:Arial;max-width:400px;margin:80px auto;background:#0f1115;color:#eee;text-align:center;padding:0 16px}
    .box{background:#181b22;padding:24px;border-radius:10px}button,a.btn{display:inline-block;margin-top:14px;padding:10px 18px;background:#4f8cff;border-radius:8px;color:#fff;text-decoration:none;border:none}</style>
