...
body {
    ...
    color: var(--text);
    background:
        radial-gradient(circle at 8% -10%, rgba(0, 242, 254, 0.16), transparent 48rem),
        radial-gradient(circle at 94% 10%, rgba(139, 92, 246, 0.14), transparent 44rem),
        radial-gradient(circle at 50% 85%, rgba(236, 72, 153, 0.05), transparent 40rem),
        var(--bg);
}
body::before {
...
h4 { font-size: 12.5px; font-family: var(--font-mono); letter-spacing: .05em; color: var(--text-dim); text-transform: uppercase; margin: 0 0 8px; }
...
input:focus, select:focus, textarea:focus {
    outline: none; border-color: var(--cyan); box-shadow: 0 0 0 3px rgba(0, 242, 254, 0.16);
}

button {
    min-height: 40px; padding: 8px 16px; border: none; border-radius: var(--r-md);
    background: var(--grad-btn); color: #060810; font-family: var(--font-body); font-weight: 700; font-size: 13px;
...
button.danger:hover { background: rgba(244, 63, 94, 0.25); filter: none; }
button.warn {
    background: rgba(245, 158, 11, 0.14); border: 1px solid rgba(245, 158, 11, 0.35);
    color: var(--warn); box-shadow: none;
}
button.warn:hover { background: rgba(245, 158, 11, 0.25); filter: none; }
...
.box::before {
    ...
    background: linear-gradient(90deg, rgba(0, 242, 254, 0.6), rgba(139, 92, 246, 0.4) 35%, transparent 65%);
}
...
.ok { background: rgba(16, 185, 129, 0.12); border: 1px solid rgba(16, 185, 129, 0.28); color: var(--success); }
.err { background: rgba(244, 63, 94, 0.12); border: 1px solid rgba(244, 63, 94, 0.28); color: var(--danger); }
...
.badge.active, .badge.on { background: rgba(16, 185, 129, 0.14); border-color: rgba(16, 185, 129, 0.28); color: var(--success); }
.badge.pending { background: rgba(245, 158, 11, 0.14); border-color: rgba(245, 158, 11, 0.28); color: var(--warn); }
.badge.expired { background: rgba(244, 63, 94, 0.14); border-color: rgba(244, 63, 94, 0.28); color: var(--danger); }
.badge.off { background: rgba(147, 161, 181, 0.1); border-color: var(--line); color: var(--text-dim); }
...
.loginbox h2 {
    ...
    background: linear-gradient(135deg, #FFFFFF 30%, #00F2FE 80%, #C084FC 100%);
...
.game-card {
    ...
    background: rgba(7, 10, 16, 0.5); box-shadow: inset 0 1px rgba(255,255,255,0.025); margin-bottom: 12px;
    transition: border-color .15s, transform .15s;
}
.game-card:hover { transform: translateY(-2px); border-color: rgba(0, 242, 254, 0.3); }
...
/* Key Link Card */
.getkey-link-card {
    margin-top: 14px; padding: 16px; border: 1px solid rgba(0, 242, 254, 0.2); border-radius: var(--r-lg);
    background: linear-gradient(135deg, rgba(0, 242, 254, 0.08), rgba(139, 92, 246, 0.06));
}
...
.getkey-link-row button {
    min-height: 42px; background: #FFFFFF; color: #060810; border-radius: var(--r-md); padding: 0 16px;
...
.topbar b::before { content: "HQ / "; color: var(--cyan); font: 10px var(--font-mono); letter-spacing: .12em; }
.topbar > a {
...
.topbar > a:hover { border-color: rgba(0, 242, 254, 0.45); color: var(--cyan) !important; }
.hamburger {
...
.sidebar-item.active { border-color: rgba(0, 242, 254, 0.25); background: linear-gradient(90deg, rgba(0, 242, 254, 0.12), rgba(139, 92, 246, 0.05)); font-weight: 700; }
.sidebar-item.active .ic { color: var(--cyan); filter: drop-shadow(0 0 8px rgba(0, 242, 254, 0.6)); }
...
.sidebar-avatar {
    ...
    display: flex; align-items: center; justify-content: center; font-weight: 700; color: #060810; font-size: 14px; flex-shrink: 0;
...
.stat-card {
    ...
    background: linear-gradient(145deg, rgba(27,38,53,0.65), rgba(7,10,16,0.5)); text-align: center;
    transition: transform .15s, border-color .15s;
}
.stat-card:hover { transform: translateY(-2px); border-color: rgba(0, 242, 254, 0.35); }
.stat-ic { display: block; margin: 0 auto 6px; color: var(--cyan); opacity: .85; }
.stat-num { font-family: var(--font-mono); font-size: 26px; font-weight: 700; color: var(--cyan); letter-spacing: -.03em; font-variant-numeric: tabular-nums; }
...
.power-toggle {
    ...
    transition: background .25s ease; padding: 0; box-shadow: 0 0 0 6px rgba(16, 185, 129, 0.08);
}
.power-toggle.on { background: linear-gradient(135deg, var(--success), #059669); }
.power-toggle.off { background: #262b38; box-shadow: 0 0 0 6px rgba(255,120,133,0.06); }
.power-toggle-knob {
    position: absolute; top: 4px; width: 32px; height: 32px; border-radius: 50%; background: #fff;
    box-shadow: 0 2px 6px rgba(0,0,0,0.35); transition: left .25s var(--ease-spring);
}
