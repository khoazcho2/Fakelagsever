...
if (isset($_SESSION['is_admin'])) {
    ...
    if (isset($_POST['create_reseller'])) {
        $resellerResult = create_reseller($_POST['reseller_username'] ?? '', $_POST['reseller_password'] ?? '');
    }
...
<?php else: ?>
    ...
    <div class="box">
        ...
        <form method="post">
            <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($_SESSION['csrf_token'] ?? '') ?>">
            <input type="text" name="reseller_username" required maxlength="32" placeholder="Username (chữ/số/gạch dưới)" style="width:220px">
            <input type="text" name="reseller_password" required maxlength="64" placeholder="Mật khẩu (tối thiểu 6 ký tự)" style="width:220px">
    ...
    <div class="box">
        ...
        <div class="tablewrap">
            <table>
                <tr><th>Username</th><th>Ngày tạo</th><th>Trạng thái</th><th>Trang riêng</th><th></th></tr>
                ...
                <?php endforeach; ?>
                <?php if (empty($resellerList)): ?><tr><td colspan="5" style="color:var(--text-dim);text-align:center;padding:24px">Chưa có reseller nào.</td></tr><?php endif; ?>
            </table>
        </div>
    </div>
