...
<?php else: ?>
    ...
    <div class="box">
        ...
        <?php else:
            $lastBackup = firebase_get('backup/latest/backed_up_at');
        ?>
            <p style="font-size:13px;color:#4caf50">✅ Đã bật - dữ liệu tự động sao lưu lên Firebase sau mỗi thay đổi.</p>
            <p style="font-size:12px;color:#888">Lần sao lưu gần nhất: <?= $lastBackup ? fmt_time((int)$lastBackup) : 'chưa có' ?></p>
        <?php endif; ?>
    </div>
