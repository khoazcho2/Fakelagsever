...
// ------------------------------------------------------------
define('FIREBASE_DB_URL', rtrim(getenv('FIREBASE_DB_URL') ?: '', '/'));
define('FIREBASE_SERVICE_ACCOUNT_JSON', getenv('FIREBASE_SERVICE_ACCOUNT_JSON') ?: '');
...
function backup_to_firebase(PDO $pdo): void {
    ...
    try {
        ...
        firebase_put('backup/latest', $payload);
    } catch (Throwable $e) {
