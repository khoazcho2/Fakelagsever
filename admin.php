...
.badge.active, .badge.on { background: rgba(97, 230, 164, 0.12); border-color: rgba(97, 230, 164, 0.25); color: var(--success); }
.badge.pending { background: rgba(245, 201, 105, 0.12); border-color: rgba(245, 201, 105, 0.25); color: var(--warn); }
.badge.expired { background: rgba(255, 120, 133, 0.12); border-color: rgba(255, 120, 133, 0.25); color: var(--danger); }
...
.topbar > a:hover { border-color: rgba(89,245,213,0.4); color: var(--cyan) !important; }
.hamburger {
...
.stat-card:hover { transform: translateY(-2px); border-color: rgba(89,245,213,0.3); }
...
.power-toggle {
    ...
    transition: background .25s ease; padding: 0; box-shadow: 0 0 0 6px rgba(97,230,164,0.07);
}
