...
/* Toast báo "đã sao chép" - góc trên phải, tự trượt vào/ra */
.toast{
    position:fixed;top:18px;right:18px;z-index:200;display:flex;align-items:center;gap:9px;
    padding:12px 16px;border-radius:13px;border:1px solid rgba(97,230,164,.3);
    background:linear-gradient(135deg,rgba(22,31,44,.97),rgba(12,17,26,.99));
    box-shadow:0 16px 34px -14px rgba(0,0,0,.6),inset 0 1px rgba(255,255,255,.06);
    color:var(--text);font-size:13px;font-weight:600;
    transform:translateX(calc(100% + 30px));opacity:0;transition:transform .32s cubic-bezier(.16,1,.3,1),opacity .32s ease;
...
@media (prefers-reduced-motion:reduce){.toast{transition:opacity .15s ease}.toast:not(.show){transform:none}}
