...
function get_site_counter(string $name): int {
    ...
    // Chưa có dòng nào cho counter này - tự khởi tạo ngay tại đây bằng
    // đúng số liệu thật đang có trong bảng keys, thay vì trả về 0 (0 sẽ
    // làm ẩn hẳn dòng "Đã phát X key" trên trang chủ do điều kiện
    // hiển thị là > 0).
