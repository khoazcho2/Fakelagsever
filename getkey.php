...
function render_key_type_select(array $game, ?array $notice, string $rParam = ''): void {
    ...
    .opt:hover { border-color: rgba(89,245,213,.4); transform: translateY(-2px); background: rgba(var(--ds-surface-rgb), 0.9); }
    ...
    .opt-badge {
        ...
        background: rgba(89,245,213,.12); color: var(--ds-cyan); border: 1px solid rgba(89,245,213,.2);
    }
...
function render_channel_gate(array $game, array $channels, string $token, string $gateToken, ?array $notice, string $error = '', array $openedChannels = [], bool $isAdmin = false, string $rParam = ''): void {
    ...
    .channel-icon {
        ...
        border-radius: var(--r-sm); background: rgba(89,245,213,.1); border: 1px solid rgba(89,245,213,.2);
    ...
    .channel a.gate-btn {
        ...
        padding: 6px 12px; border-radius: var(--r-sm); background: var(--grad-btn); color: #071018;
    ...
    .channel a.gate-btn.waiting {
        background: var(--ds-surface2); color: var(--ds-cyan); border: 1px solid rgba(89,245,213,.35);
    }
