...
if (isset($_SESSION['is_admin'])) {
    ...
    if (isset($_POST['add_game'])) {
        ...
        $slug = trim($slug, '-'); // cắt dấu gạch ngang thừa ở đầu/cuối (vd "fakelag-" -> "fakelag")
        if ($slug !== '') {
    ...
    // Cập nhật cấu hình 1 khu vực (vn/intl) của 1 game
...
body{font-family:-apple-system,Arial,sans-serif;font-size:14px;max-width:900px;margin:20px auto;background:#0f1115;color:#eee;padding:0 12px}
h2{font-size:19px}h3{font-size:16px}h4{font-size:13px}
input,select{padding:8px;margin:5px 4px 5px 0;border-radius:6px;border:1px solid #333;background:#1a1d24;color:#eee;font-size:13px;max-width:100%}
button{padding:9px 14px;background:#4f8cff;border:none;border-radius:6px;color:#fff;font-weight:bold;cursor:pointer;font-size:13px}
button.danger{background:#e05353}
button.warn{background:#c98a2d}
button.small{padding:5px 10px;font-size:12px}
.box{background:#181b22;padding:16px;border-radius:10px;margin-bottom:16px}
...
.game-card{background:#12141a;border-radius:8px;padding:12px;margin-bottom:10px}
