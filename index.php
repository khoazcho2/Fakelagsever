...
$gameCooldowns = [];
foreach ($games as $g) {
    $gameCooldowns[$g['id']] = get_claim_cooldown_remaining((int)$g['id'], $clientIp);
}
...
<div class="wrap">
    ...
    <div class="ip-box">
        <div class="ip-box-left">
            ...
            <div>
                <div class="ip-label">IP CỦA BẠN</div>
                <div class="ip-value"><?= htmlspecialchars($clientIp ?: 'Không xác định') ?></div>
            </div>
        </div>
        <div class="ip-box-note">Chỉ mình bạn thấy được thông tin này</div>
    </div>
    ...
    <div class="card" style="animation-delay:<?= $i * 0.07 ?>s">
        ...
        <div class="card-body">
            ...
            <div class="card-info">
                ...
                <div class="gmeta">
                    <?php if ($cooldown > 0): ?>
                        <span class="cooldown-pill" data-remaining="<?= $cooldown ?>"><span class="dot"></span> Còn lại <span class="cd-text"><?= format_duration_label($cooldown) ?></span></span>
                    <?php else: ?>
        ...
        <div class="card-cta">
            <?php if ($cooldown > 0): ?>
                <a class="btn btn-disabled" data-remaining="<?= $cooldown ?>" onclick="return false;">⏳ Còn <span class="cd-text"><?= format_duration_label($cooldown) ?></span></a>
            <?php else: ?>
