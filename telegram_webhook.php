...
function render_tg_membership_content(int $userId, string $firstName, string $payload = ''): array {
    ...
    if ($allJoined) {
        ...
        $text = "⚡ <b>XÁC THỰC THÀNH VIÊN THÀNH CÔNG!</b>\n\n" .
                "👋 Chào <b>{$escapedName}</b>,\n" .
                "✅ Bạn đã tham gia đầy đủ tất cả các nhóm bắt buộc:\n\n" .
                implode("\n", $statusLines) . "\n\n" .
        ...
        $text = "⚡ <b>XÁC THỰC THÀNH VIÊN BOT TELEGRAM</b>\n\n" .
                "👋 Chào <b>{$escapedName}</b>,\n" .
                "⚠️ Bạn chưa tham gia đủ {$totalGroups} nhóm bắt buộc:\n\n" .
                implode("\n", $statusLines) . "\n\n" .
                "📦 <b>Giao hàng:</b> Tự động sau khi bot kiểm tra đủ\n" .
                "⚠️ <b>Quy định:</b> Thoát nhóm sau khi nhận key sẽ bị huỷ key tự động!\n\n" .
