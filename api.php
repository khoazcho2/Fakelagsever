...
// set_security_headers() CỐ Ý đặt SAU nhánh này - gọi trước sẽ làm lộ
// header ngay cả khi server "đóng", phá vỡ đúng hành vi "im lặng hoàn
// toàn" mà công tắc này cần.
if (is_server_closed()) {
    exit;
}
