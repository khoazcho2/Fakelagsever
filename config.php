...
:root {
    ...
    --ds-bg-top: #0B1019;
    --ds-surface: #101620;
    --ds-surface-rgb: 16,22,32;
    --ds-surface2: #151D2A;
    --ds-surface3: #1B2635;
    --ds-line: rgba(177,199,224,.12);
    --ds-line-strong: rgba(177,199,224,.2);
    --ds-cyan: #59F5D5;
    --ds-violet: #9C8CFF;
    --ds-text: #F4F7FB;
    --ds-text-dim: #93A1B5;
    --ds-text-muted: #657287;
    --ds-success: #61E6A4;
    --ds-warn: #F5C969;
    --ds-danger: #FF7885;
    --ds-grid-line: rgba(255,255,255,.025);
    ...
    /* Shadows */
    --shadow-card: 0 16px 40px -28px rgba(0,0,0,.7), inset 0 1px rgba(255,255,255,.045);
    --shadow-card-hover: 0 22px 50px -28px rgba(0,0,0,.8), 0 0 0 1px rgba(89,245,213,.12);
    --shadow-btn: 0 12px 25px -14px rgba(89,245,213,.7);
    --shadow-float: 0 30px 80px -30px rgba(0,0,0,.9), inset 0 1px rgba(255,255,255,.07);

    /* Transitions */
    --ease-out: cubic-bezier(.16,1,.3,1);
    --ease-spring: cubic-bezier(.34,1.56,.64,1);
    --dur-fast: .15s; --dur-normal: .25s; --dur-slow: .4s;

    /* Gradient shortcuts */
    --grad-holo: linear-gradient(90deg, var(--ds-cyan), var(--ds-violet), #F0A6FF, var(--ds-cyan));
    --grad-btn: linear-gradient(110deg, var(--ds-cyan), #B5FFF0 45%, var(--ds-violet));
    --grad-card: linear-gradient(145deg, rgba(22,31,44,.97), rgba(12,17,26,.99));
}
...
html[data-theme="light"] {
    ...
    --ds-surface2: #EDF0F6;
    --ds-surface3: #E3E8F0;
    --ds-line: rgba(30,41,59,.12);
    --ds-line-strong: rgba(30,41,59,.22);
    --ds-cyan: #0EA88E;
    --ds-violet: #6D5AE0;
    --ds-text: #151A23;
    --ds-text-dim: #5B6472;
    ...
    --ds-warn: #B8860B;
    --ds-danger: #DC2626;
    --ds-grid-line: rgba(15,23,42,.045);
    --shadow-card: 0 10px 26px -20px rgba(30,41,59,.18), inset 0 1px rgba(255,255,255,.6);
    --shadow-card-hover: 0 16px 34px -20px rgba(30,41,59,.22), 0 0 0 1px rgba(14,168,142,.15);
    --shadow-btn: 0 10px 20px -12px rgba(14,168,142,.45);
    --shadow-float: 0 20px 50px -20px rgba(30,41,59,.25), inset 0 1px rgba(255,255,255,.7);
    --grad-card: linear-gradient(145deg, rgba(255,255,255,.98), rgba(248,250,252,.99));
}
...
.ds-eyebrow {
    ...
    padding: 7px 11px; border: 1px solid var(--ds-line); border-radius: var(--r-full);
    background: rgba(var(--ds-surface-rgb), .72); box-shadow: 0 8px 24px rgba(0,0,0,.18);
    font: var(--fw-semi) var(--fs-xs) var(--font-mono); letter-spacing: .18em;
...
.ds-eyebrow span { color: var(--ds-cyan); }
...
.ds-btn {
    ...
    min-height: 48px; padding: 13px var(--sp-4); border: 0; border-radius: var(--r-md);
    color: #071018; background: var(--grad-btn); box-shadow: var(--shadow-btn);
    font: var(--fw-bold) var(--fs-base) var(--font-body);
    text-decoration: none; cursor: pointer; transition: transform var(--dur-fast), filter var(--dur-fast);
    width: 100%;
}
.ds-btn:hover { filter: brightness(1.08); }
.ds-btn:active { transform: scale(.97); }
html[data-theme="light"] .ds-btn { color: #fff; }

.ds-btn-ghost {
    display: inline-flex; align-items: center; justify-content: center; gap: var(--sp-2);
    min-height: 44px; padding: 11px var(--sp-4); border: 1px solid var(--ds-line-strong);
    border-radius: var(--r-md); background: rgba(var(--ds-surface-rgb), .6);
    color: var(--ds-text-dim); font: var(--fw-semi) var(--fs-sm) var(--font-body);
    text-decoration: none; cursor: pointer; transition: border-color var(--dur-fast), color var(--dur-fast);
}
.ds-btn-ghost:hover { border-color: rgba(89,245,213,.4); color: var(--ds-cyan); }

/* ---- Badge / Pill ---- */
.ds-step-pill {
    display: inline-flex; align-items: center; gap: 7px; padding: 6px 12px;
    border-radius: var(--r-full); background: rgba(156,140,255,.11);
    color: #C9C0FF; font: var(--fw-semi) var(--fs-xs) var(--font-mono); letter-spacing: .06em;
}
.ds-status-dot {
...
.ds-icon-badge {
    ...
    font-size: 26px; box-shadow: 0 0 0 8px rgba(89,245,213,.04);
}
.ds-icon-badge--success {
    background: rgba(97,230,164,.1); border: 1px solid rgba(97,230,164,.22);
    color: var(--ds-success);
}
.ds-icon-badge--cyan {
    background: rgba(89,245,213,.1); border: 1px solid rgba(89,245,213,.22);
    color: var(--ds-cyan);
}
.ds-icon-badge--violet {
    background: rgba(156,140,255,.1); border: 1px solid rgba(156,140,255,.22);
    color: var(--ds-violet);
}
.ds-icon-badge--danger {
    background: rgba(255,120,133,.1); border: 1px solid rgba(255,120,133,.22);
    color: var(--ds-danger);
}

/* ---- Progress bar ---- */
.ds-progress { height: 5px; background: var(--ds-surface2); border-radius: var(--r-sm); overflow: hidden; }
.ds-progress-fill { height: 100%; border-radius: inherit; background: linear-gradient(90deg, var(--ds-cyan), var(--ds-violet)); transition: width 1s ease; }

/* ---- Spinner ---- */
.ds-spinner {
    width: 48px; height: 48px; margin: 0 auto var(--sp-4);
    border: 3px solid rgba(89,245,213,.14);
...
.ds-toast {
    ...
    border-radius: var(--r-md); border: 1px solid rgba(97,230,164,.3);
    background: var(--grad-card); box-shadow: var(--shadow-card);
    color: var(--ds-text); font-size: 13px; font-weight: var(--fw-semi);
...
.ds-toast-icon {
    ...
    background: rgba(97,230,164,.15); color: var(--ds-success);
    display: flex; align-items: center; justify-content: center; flex-shrink: 0;
}

/* ---- Notice callout ---- */
.ds-notice {
    margin: var(--sp-4) 0 0; padding: 11px 12px; border-radius: var(--r-md);
    border: 1px solid rgba(89,245,213,.18); background: rgba(89,245,213,.06);
    text-align: left;
}
.ds-notice strong { display: block; margin-bottom: 3px; font-size: 11px; }
.ds-notice p { font-size: 11px; margin: 0; }
.ds-notice.warning { border-color: rgba(245,201,105,.25); background: rgba(245,201,105,.07); }
.ds-notice.success { border-color: rgba(97,230,164,.25); background: rgba(97,230,164,.07); }
.ds-notice.error { border-color: rgba(255,156,166,.22); background: rgba(255,120,133,.08); color: var(--ds-danger); }

/* ---- Game pill ---- */
.ds-game-pill {
    display: inline-flex; align-items: center; gap: 7px; margin-top: var(--sp-4);
    padding: 7px 10px; border-radius: var(--r-full);
    background: rgba(156,140,255,.1); color: #CAC3FF; font-size: 11px;
}

/* ---- Centered page layout for flow pages ---- */
.ds-page {
    min-height: 100vh; margin: 0; padding: var(--sp-6) var(--sp-4);
    display: grid; place-items: center;
    background:
        radial-gradient(circle at 12% 0%, rgba(89,245,213,.14), transparent 28rem),
        radial-gradient(circle at 90% 12%, rgba(156,140,255,.11), transparent 26rem),
        linear-gradient(180deg, var(--ds-bg-top) 0%, var(--ds-bg) 60%);
}
html[data-theme="light"] .ds-page {
    background:
        radial-gradient(circle at 12% 0%, rgba(14,168,142,.08), transparent 28rem),
        radial-gradient(circle at 90% 12%, rgba(109,90,224,.06), transparent 26rem),
        linear-gradient(180deg, var(--ds-bg-top) 0%, var(--ds-bg) 60%);
}
.ds-page-inner { width: min(100%, 440px); }
...
@media (max-width: 480px) {
    .ds-toast { left: 18px; right: 18px; top: 14px; }
}
CSS;
}
