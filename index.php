...
// hàm attempt_reset_key() trong config.php.
$resetResult = null;
...
<div class="wrap">
    ...
    <div class="reset-box">
        <div class="reset-title">🔄 Reset Key</div>
        <p class="reset-sub">Chỉ áp dụng cho <b>Key 40 giờ</b> (vượt 2 lần link) - làm mới lại thời hạn 40h và gỡ thiết bị cũ để đăng nhập máy khác. <b>Mỗi key chỉ được reset 1 lần duy nhất.</b></p>
        <form class="reset-form" method="post" action="index.php#reset">
