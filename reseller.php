...
.badge.on, .badge.active { background: rgba(16, 185, 129, 0.14); border-color: rgba(16, 185, 129, 0.28); color: var(--success); }
.badge.warn, .badge.pending { background: rgba(245, 158, 11, 0.14); border-color: rgba(245, 158, 11, 0.28); color: var(--warn); }
...
.topbar > a:hover, .topbar-right > a:hover { border-color: rgba(0, 242, 254, 0.45); color: var(--cyan) !important; }
.lang-switch {
...
.lang-switch a.active { background: var(--grad-btn); color: #060810; font-weight: 700; }
...
.rent-unit b { display: block; font-size: 20px; color: var(--cyan); font-family: var(--font-mono); font-variant-numeric: tabular-nums; font-weight: 700; line-height: 1.1; text-shadow: 0 0 16px rgba(0, 242, 254, 0.4); }
